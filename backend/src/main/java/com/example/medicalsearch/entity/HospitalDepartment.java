...
public enum HospitalDepartment {
    ...
    SURGERY("D006", "외과"),
    CARDIOTHORACIC_SURGERY("D007", "흉부외과", "심장혈관흉부외과"),
    ...
    UROLOGY("D014", "비뇨기과", "비뇨의학과"),
    TUBERCULOSIS("D015", "결핵과"),
    REHABILITATION_MEDICINE("D016", "재활의학과"),
    ANESTHESIOLOGY_PAIN_MEDICINE("D017", "마취통증의학과", "마취통증과"),
    RADIOLOGY("D018", "영상의학과"),
    THERAPEUTIC_RADIOLOGY("D019", "치료방사선과"),
    CLINICAL_PATHOLOGY("D020", "임상병리과"),
    ANATOMICAL_PATHOLOGY("D021", "해부병리과"),
    FAMILY_MEDICINE("D022", "가정의학과"),
    NUCLEAR_MEDICINE("D023", "핵의학과"),
    EMERGENCY_MEDICINE("D024", "응급의학과"),
    OCCUPATIONAL_MEDICINE("D025", "산업의학과"),
    DENTISTRY("D026", "치과"),
    KOREAN_INTERNAL_MEDICINE("D027", "한방내과"),
    KOREAN_GYNECOLOGY("D028", "한방부인과"),
    PREVENTIVE_MEDICINE("D029", "예방의학과"),
    ...
    public static String officialNameFor(String publicDataCode) {
        if (publicDataCode == null) {
            return null;
        }
        for (HospitalDepartment department : values()) {
            if (publicDataCode.equalsIgnoreCase(department.publicDataCode)) {
                return department.officialName;
            }
        }
        return publicDataCode;
    }
